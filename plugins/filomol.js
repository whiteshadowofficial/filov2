...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'filo ?(.*)', fromMe: true, desc: Lang.BOT_DESC}, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'filo ?(.*)', fromMe: false, desc: Lang.BOT_DESC}, async (message, match) => {
	if (match[1] === 'xx') return await message.reply(Lang.NEED_LOCATIONA);
