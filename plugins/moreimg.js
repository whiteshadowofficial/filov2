...
Asena.addCommand({pattern: 'moretxt', fromMe: false, desc: Lang.TXTTOIMG_DESC}, (async (message, match) => {    
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*𝗠𝗔𝗗𝗘 𝗕𝗬 𝗙𝗜𝗟𝗢✰*'})
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*𝗠𝗔𝗗𝗘 𝗕𝗬 𝗙𝗜𝗟𝗢✰*𝗠𝗔𝗗𝗘 𝗕𝗬 𝗙𝗜𝗟𝗢✰*'})
